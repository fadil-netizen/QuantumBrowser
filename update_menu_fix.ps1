...
$endMarker = "private void OpenNewWindow(bool incognito)"
...
if ($startIndex -ge 0 -and $endIndex -gt $startIndex) {
    ...
    $newCode = @"
        private void ShowMenu(object sender, EventArgs e)
        {
            ...
            // Helper Delegate (C# 5 Compatible)
            ...
            btnFull.Click += delegate { if(this.WindowState == FormWindowState.Normal) this.WindowState = FormWindowState.Maximized; else this.WindowState = FormWindowState.Normal; };
            ...
            itemFind.DropDownItems.Add("Find...", null, (s, ev) => {/* Find logic */}); 
            
            var itemCast = AddItem(T("Cast, save, and share"), null, "");
            itemCast.DropDownItems.Add("Cast...", null, (s, ev) => {/* Cast logic */});
